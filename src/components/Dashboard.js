...
const Dashboard = (props) => {
    ...
    const [fiatname, setfiatname] = useState('usd');
    ...
    function showUpdatedChart() {
        console.log(`showUpdatedChart`);
        ...
        <div className="dashboard">
            <div className="header">
                ...
                <div className="crptofiat_container">
                    ...
                    <input className="crptofiat_input" placeholder="usd" onChange={handleFiatNameChange}></input>
                    <button className="crptofiat_button" onClick={() => showUpdatedChart()}>Show</button>
                </div>
            </div>
            <div className='main_chart_container' >
                {
                    ...
                    <AreaChart className="main_chart" width={1600} height={550} data={cryptoState} >
                        ...
                        <XAxis dataKey="time" style={{ fontFamily: 'Space Grotesk', fontSize: '0.9rem',}}/>
